...
首先十分感谢 @mzlogin 提供了这个模板，好看且实用。（项目地址：https://github.com/mzlogin/mzlogin.github.io）
...
例如: `首页` 按钮的正常链接的 url 应该是 `https://miopas.github.io/blog/`，点击 `首页` 的时候，跳转的页面的链接是 `https://miopas.github.io/`。尝试各种修改了 `_config.yml` 中的配置都无效果。最后还是选择了用 master 分支的方式来搭建，一切正常。
